...
;mixes the list and finds a new position to every element with the function 'move'
...
;finds the sum of the three numbers that form the grove coordinates after 10 mixes; works a bit slow
(display (sumIt (10-times vals) vals))
