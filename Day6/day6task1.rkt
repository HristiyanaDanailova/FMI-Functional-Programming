...
;creates a 4-element list for every element of l and if it is a marker,it returns the index
(define (marker l)
...
;the number of characters before the first start-of-packet marker 
